 ...
 *
 */
@WebServlet("/EmailSendingServletRent")

public class EmailSendingServletRent extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request,
    	...
    	int z=dd.Duplicate("rent", request.getParameter("Email"));
    	if(z==2)
    	{
 ...
 */
       ...
       String Cacc=request.getParameter("accCheck");
       ...
       s.setAttribute("Account", acc);
       s.setAttribute("IFSC", IFSC);
       s.setAttribute("RES", "RENT");
       if(!acc.equals(Cacc))
       {
    	   RequestDispatcher rd=request.getRequestDispatcher("RentReg.jsp");
       	rd.include(request,response);
       	out.println("\n"+"<script>window.alert('Account Number Did not Match');</script>"); 
       }
