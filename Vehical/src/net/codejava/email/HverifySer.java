...
/**
 * Servlet implementation class HverifySer
 */
@WebServlet("/HverifySer")
public class HverifySer extends HttpServlet {
...
System.out.println(email);  
   ...
   String content = "Welcome to Parth Web Services"+"\n\n"+"Welcome to the world of Parth Web Technology."
   		...
   		"Congratulations! Your Documents are verified."+"\n\n"+" Welcome To GO RENT "+"\n"+"You are now Authorized to Hire Vehicle on GO RENT."
...
;
    ...
    try {
    	...
    	RequestDispatcher rd=request.getRequestDispatcher("haprv.jsp");
