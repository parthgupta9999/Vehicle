...
try{
	Map<Ongoing,Vehicle> m=d.Current(id);
for(Map.Entry<Ongoing,Vehicle> al : m.entrySet())
{
              ...
              <div class="car-item">
                ...
                <div class="car-item-body">
                  <div class="content">
                    ...
                    <br>
                   <i >&#9981;</i><%=" "+v.getVfuel()%>
                    <form class="registration-form" action="Finish" method="post">
                <div class="frm-group">
                  <input type=number name=read placeholder="ODOMETER READING">
                </div>
                <input type="hidden" name="email" value="<%=v.getEmail()%>">
<input type="hidden" name="rc" value="<%=v.getRcnum()%>">
