...
String rcn=(String)s.getAttribute("Rnum");
String rcp=(String)s.getAttribute("RC");
String vp=(String)s.getAttribute("Vehicle");
String vtype=(String)s.getAttribute("Type");
String gps=(String)s.getAttribute("GPS");
String vname=(String)s.getAttribute("Vname");
String vmod=(String)s.getAttribute("Vmod");
String vfuel=(String)s.getAttribute("Vfuel");
String mread=(String)s.getAttribute("Mread");
...
<body>
 ...
 <header class="header-section">
      ...
      <div class="row">
        <div class="col-md-12">
          ...
          <ol class="page-list">
            ...
            <li>Upload Registration Copy Card</li>
          <li>Upload Vehicle Image</li>
          <li>Registration Response</li>
           </ol>
        </div>
      </div>
    </div>
  ...
  <br>
              ...
              <form class="registration-form" action = "RentHome.jsp" method = "post">
