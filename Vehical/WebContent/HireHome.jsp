...
try{
	Map<Vrent,Vehicle> m=d.Rentlist();
for(Map.Entry<Vrent,Vehicle> al : m.entrySet())
{
	
Vrent r=al.getKey();
Vehicle v=al.getValue(); %>
              ...
              <div class="car-item">
                ...
                <div class="car-item-body">
                  <div class="content">
                    ...
                    <br>
                   <i >&#9981;</i><%=" "+v.getVfuel()%>
                   <p> Base Price : <i  >&#8377; <%=" "+r.getBfare()%></i></p>
                   <p> RATE per KM: <i  >&#8377; <%=" "+r.getKfare()%></i></p>
                   <br>
                  <p><i >&#127750;</i> <%=r.getCity() %>
                   <form action="RentMail" method="post">
<input type="hidden" name="regno" value="<%=v.getRcnum()%>">
<input type="hidden" name="vname" value="<%=v.getVname()%>">
<input type="hidden" name="email" value="<%=v.getEmail()%>">
<input type="hidden" name="mod" value="<%=v.getVmod()%>">
<input type="hidden" name="add" value="<%=r.getAddress()%>">
<input type="hidden" name="city" value="<%=r.getCity()%>">
<input type="hidden" name="mread" value="<%=r.getMread()%>">
<input type="hidden" name="fuel" value="<%=v.getVfuel()%>">
<input type="hidden" name="etime" value="<%=r.getEtime()%>">
<input type="hidden" name="base" value="<%=r.getBfare()%>">
<input type="hidden" name="pkm" value="<%=r.getKfare()%>">
<input type="hidden" name="date" value="<%=r.getDate()%>">
<input type="hidden" name="gps" value="<%=v.getGps()%>">
          ...
          <aside class="sidebar">
            ...
            <div class="widget widget-reservation text-center">
              ...
              <div class="widget-body">
                <i class="fa fa-user-circle" style="font-size: 750%;"></i><br><br><p style="font-size : 20px"><%=h.getName() %></p>
               <br>
               <i class="fa fa-phone" style="font-size:20px"><%=" "+h.getMobileNumber()%></i>
               <br> <br>
               <i class="fa fa-trophy" style="font-size:20px"><%=" "+h.getRidesDone()%></i>
              <br> <br>
               <i  style="font-size:20px">&#8377; <%=" "+h.getDue()+" DUE"%></i>
               <br><br>
                <a href="logoutt.jsp" class="cmn-btn">Log Out</a>
