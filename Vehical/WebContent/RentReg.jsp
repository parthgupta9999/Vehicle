        ...
        <div class="col-lg-12">
          <div class="registration-block text-center">
            <div class="registration-block-inner">
              <h3 class="title">create  your Rent account</h3>
              <form class="registration-form" action="EmailSendingServletRent" method="post">
                <div class="frm-group">
                  <input type="number" name="adharnum" placeholder="Adhar Number">
                </div>
                <div class="frm-group">
                  <input type="text" name="name" placeholder="Name">
                </div>
                <div class="frm-group">
                  <input type="number" name="drLinum" placeholder="Driving License">
                </div>
                <div class="frm-group">
                ...
                <div class="frm-group">
                  <input type="number" name="acc" placeholder="Account Number">
                </div>
                <div class="frm-group">
                  <input type="password" name="accCheck" placeholder="Re Account Number">
                </div>
                <div class="frm-group">
