						...
						<table>
							<thead>
								<tr class="row100 head">
									<th class="cell100 column1">RC Number</th>
...
s.invalidate();
try{	
List<Vehicle> al=d.VDetails("UNVERIFIED");
...
for(Vehicle h:al)
{
	...
	%>
								...
								<tr class="row100 body">
									<td class="cell100 column1"><%=h.getRcnum() %></td>
									<td class="cell100 column2"><%=h.getVname() %></td>
									<td class="cell100 column3"><a href="RShowL.jsp?email=<%=h.getEmail() %>" class="cmn-btn"><%=h.getEmail() %></a></td>
									<td class="cell100 column3"><a href="VShow.jsp?rc=<%=h.getRcnum() %>" class="cmn-btn">Details</a></td>
								</tr>
<%
}
}catch(Exception e)
