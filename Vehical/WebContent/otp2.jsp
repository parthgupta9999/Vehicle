 ...
 <header class="header-section">
  ...
  <section class="inner-page-banner bg_img overlay-3" data-background="assets/images/inner-page-bg.jpg">
    <div class="container">
      <div class="row">
        <div class="col-md-12">
          <h2 class="page-title">Finish Rent</h2>
          <ol class="page-list">
        ...
        <div class="col-lg-12">
          <div class="registration-block text-center">
            <div class="registration-block-inner">
              <h3 class="title">Verify OTP Sent on Your Email </h3>
              <form class="registration-form" Action="ootp2.jsp" method="post">
                <div class="frm-group">
                  <input type="number" name="eotp" placeholder="Please enter OTP sent to Renter Email">
                </div>
