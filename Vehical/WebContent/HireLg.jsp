      ...
      <div class="row align-items-center">
        <div class="col-md-7">
          <div class="banner-content">
            ...
            <br>
            <br>
            <h1 class="title" style="text-align:center">HIRE  VEHICLE</h1>
            <br>
            <br>
      ...
      <div class="row">
        <div class="col-lg-12">
          <div class="car-search-area">
            <h3 class="title" style="text-align:center">Hire Login</h3>
            <br>
            <form class="car-search-form" action="HireLog.jsp" method="post">
              ...
              <p style="text-align:left ;font-size:130%"><a href="EmailForm.jsp">Register</a></p>
            </form>
            </div>
          </div>
        </div>
