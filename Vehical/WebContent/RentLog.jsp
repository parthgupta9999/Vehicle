      ...
      <div class="row align-items-center">
        <div class="col-md-7">
          <div class="banner-content">
            ...
            <br>
            <br>
            <h1 class="title" style="text-align:center">RENT VEHICLE</h1>
            <br>
            <br>
      ...
      <div class="row">
        <div class="col-lg-12">
          <div class="car-search-area">
            <h3 class="title" style="text-align:center">Rent Login</h3>
            <br>
            <form class="car-search-form" action="RentLogg.jsp" method="post">
              
              <div  align="center" >
                <div class="form-group col-md-6" align="center" >
                	                		<i class="fa fa-user-circle"></i></li>
                                  <input class="form-control has-icon" type="text" name="id" placeholder="Email / Mobile Number">
                
                	                	<br>

                                  <input class="form-control has-icon" type="password" name="pass" placeholder="Password" >
                </div>
           
              
              <button type="submit" class="cmn-btn btn-radius" >Login</button>
              <p style="text-align:left ;font-size:130%"><a href="RentReg.jsp">Register</a></p>
            </form>
            </div>
          </div>
        </div>
