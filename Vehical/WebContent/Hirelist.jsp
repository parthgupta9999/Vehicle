...
<body>
 ...
 <br>
 <br>
<h1 style="text-align:center;" >Hire List</h1>
...
s.invalidate();
try{	
List<Hire> al=d.HireDetails("VERIFIED");
...
for(Hire h:al)
{
	...
	%>
								...
								<tr class="row100 body">
									...
									<td class="cell100 column3"><a href="HrShow.jsp?email=<%=h.getEmail() %>" class="cmn-btn">Show Details</a></td>
