...
<tr class="row100 body">	
								...
								<td class="cell100 column1">Password</td>
									...
									<tr class="row100 body">
								<td class="cell100 column1">Account Number</td>
									<td class="cell100 column2"><%=h.getAccNo() %></td>
									</tr>
									<tr class="row100 body">
								<td class="cell100 column1">IFSC</td>
									<td class="cell100 column2"><%=h.getIFSC() %></td>
									</tr>
			                         <tr class="row100 body">
			                         <td class="cell100 column1"><form action="RrejSer" method="post">
			                         <input type="hidden" name="id" value="<%=h.getEmail() %>" >
			                         <input type="submit" value="Reject" style="color:red">
			                         </form></td>
		       						<td class="cell100 column1">
		       						<form action="RverifySer" method="post">
			                         <input type="hidden" name="id" value="<%=h.getEmail() %>" >
