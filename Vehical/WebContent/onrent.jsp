        ...
        <nav class="navbar navbar-expand-lg p-0">
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav main-menu mr-auto">
             ...
             <li><a href="about.html">On Rent</a>
...
List<Ongoing> al=d.OngoingDetailsR(id);
if(al.isEmpty())
{
%>
<p style="font-weight: bold;">YOU HAVE NOT RENTED ANY VEHICAL.</p>
<br>
<br>
<br>
<% 	
...
for(Ongoing o:al)
{
	List<Vehicle> all=d.VehicleDetailsR(o.getRemail());
	for(Vehicle v:all)
	{
