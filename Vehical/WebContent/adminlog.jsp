      ...
      <div class="row align-items-center">
        <div class="col-md-7">
          <div class="banner-content">
            ...
            <br>
            <br>
            <h1 class="title" style="text-align:center">ADMIN BLOCK</h1>
            <br>
            <br>
      ...
      <div class="row">
        <div class="col-lg-12">
          <div class="car-search-area">
            ...
            <br>
            <form class="car-search-form" action="admnlog.jsp" method="post">
              
              <div  align="center" >
                <div class="form-group col-md-6" align="center" >
                	                		<i class="fa fa-user-circle"></i></li>
                                  <input class="form-control has-icon"  type="text" name="id" placeholder="ID">
