...
<body>
 ...
 <br>
 <br>
<h1 style="text-align:center;" >Ongoing Ride List</h1>
					...
					<div class="table100-head">
						<table>
							<thead>
								...
								<th class="cell100 column2">GPS</th>
									<th class="cell100 column3">HEMAIL</th>
									<th class="cell100 column4">HMob</th>
									<th class="cell100 column5">REmail</th>
...
for(Ongoing h:al)
{
	...
	%>
								...
								<td class="cell100 column1"><a href="VShowL.jsp?rc=<%=h.getRcnum() %>" class="cmn-btn"><%=h.getRcnum() %></a></td>
									...
									<td class="cell100 column3"><a href="HrShow.jsp?email=<%=h.getHemail() %>" class="cmn-btn"><%=h.getHemail() %></a></td>
<td class="cell100 column4"><%=h.getHMnum() %></td>
									<td class="cell100 column5"><a href="RShowL.jsp?email=<%=h.getRemail() %>" class="cmn-btn"><%=h.getRemail() %></a></td>
								
								
								<td class="cell100 column6"><%=h.getCity() %></td>
								<td class="cell100 column7"><%=h.getDate() %></td>
								<td class="cell100 column8"><%=h.getEtime() %></td>
								</tr>
<%
}
}catch(Exception e)
